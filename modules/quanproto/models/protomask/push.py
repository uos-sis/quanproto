    ...
    for i, (search_batch_input, search_y) in data_iter:
        ...
        for proto_idx, log in push_batch_log.items():
            push_log[proto_idx] = {
                ...
                "img_index": int(log["img_index"] + img_count),
                "mask_index": int(log["mask_index"]),
...
def update_prototypes_on_batch(
    ...
    with torch.no_grad():
        ...
        # protoL_input_torch: Bx24x1280x1x1
        # proto_dist_torch: Bx24xP
    ...
    for j in range(n_prototypes):
        ...
        if batch_min_proto_dist_j < global_min_proto_dist[j]:
            ...
            push_batch_log[j] = {
                ...
                "mask_index": batch_argmin_proto_dist_j[1],
