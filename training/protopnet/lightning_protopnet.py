...
from quanproto.models.config_parser import create_protopnet
...
from quanproto.models.protopnet.push import push_prototypes
...
def train(
    ...
    parameter_config = deepcopy(
        parameter.protopnet_params[experiment_config["dataset"]]
    )
